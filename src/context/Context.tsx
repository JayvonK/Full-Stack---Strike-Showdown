...
export const AppWrapper = ({ children, }: Readonly<{ children: React.ReactNode;}>) => {
    ...
    return (
        <Context.Provider value={{initialOpen, setInitialOpen, currentState, setCurrentState, createdAccountBool, setCreatedAccountBool, changedPasswordBool, setChangedPasswordBool}}>
            {children}
        </Context.Provider>
    )
}
