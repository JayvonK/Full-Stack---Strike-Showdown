...
const MessagingPage = (props: { addNewChat: () => void, currentUser: IPublicUserData, friendArray: IPublicUserData[] }) => {
  ...
  return (
    <div className='pb-16 grid lg:grid-cols-[31%_69%] h-[80vh] z-20 relative '>
      ...
      <div className='bg-black rounded-3xl px-7 py-7 overflow-y-scroll scrollbar'>

        {/* <div className='flex justify-between items-center mb-7'> */}
          <h2 className='2xl:text-4xl xl:text-3xl lg:text-2xl sm:text-3xl text-2xl juraBold text-white mb-7'>Direct Messages</h2>
          {/* <div className='w-[45px] h-[45px]'>
            <img className='w-full h-full object-cover hover:cursor-pointer' src='/images/plus-bold.svg' alt="" onClick={props.addNewChat} />
          </div> */}
        {/* </div> */}
        ...
        {
          props.friendArray.map((friend, idx) => (
      ...
      <div className='bg-black lg:rounded-3xl rounded-xl lg:ml-4 lg:py-7 lg:px-10 py-4 px-4 relative lg:flex hidden flex-col justify-between max-h-[80vh]'>
        ...
        {
          conn === null ? (
            <h2 className='text-white jura text-4xl text-center my-auto'>Open a DM to start messaging</h2>
          ) : (
            <>
              <div>
