...
function NavBarComponent() {
  ...
  <Modal.Body>
  <h3 className="text-3xl mb-6  bg-orange-500 rounded-2xl hover:!bg-orange-500 text-center text-black jura px-4 pt-3 pb-3"style={{width:193}}>Friends</h3> 
    <div className="mb-5 grid grid-flow-col p-4  justify-evenly bg-black rounded-2xl w-50"style={{width:300}}>
  ...
  <button style={{width:150}}  className=" bg-orange-500  hover:!bg-orange-500 mb-2 text-black jura" >
    ...
    <Button className="  bg-orange-500  rounded-2xl hover:!bg-orange-500 text-black jura" style={{width:189}} onClick={() => setOpenModal(false)}>
