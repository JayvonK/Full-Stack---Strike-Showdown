      ...
      <div className="grid  grid-flow-col gap-10  md:gap-2 lg:mx-2  justify-center items-center    ">
       ...
       md:justify-center lg:justify-start  items-center"
          ...
          <div className=" grid gap-0 md:gap-1 grid-wrap justify-center pr-4  md:justify-center lg:justify-start ">
            <div>
              <button
                className=" items-center    min-w-40  lg:min-w-10 xl:min-w-0 text-xl  rounded-none  md:px-6 py-0  text-center lg:text-sm  xl:text-sm font-medium bg-orange-500   hover:!bg-orange-500 text-black jura"
              >
                Challenge
              </button>
            </div>
            <div>
              <button
                ...
                className="items-center  rounded-none text-xl   min-w-40 lg:!min-w-5 xl:text-sm lg:text-sm   md:px-7  py-0  text-center  font-medium bg-orange-500   hover:!bg-orange-500 text-black jura"
              >
                Message 
              </button>
            </div>
