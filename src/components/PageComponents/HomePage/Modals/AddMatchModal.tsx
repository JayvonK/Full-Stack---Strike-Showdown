            ...
            <div className='px-4'>
                <form onSubmit={props.edit ? props.editMatchClick : (props.addingChallengeBool ? props.create1v1Challenge : props.createPracticeSession)}>
                    ...
                    <div className='py-4 flex justify-end'>
                        {props.edit && <button type="button" className='jura lg:text-4xl md:text-3xl sm:text-2xl text-xl py-2 px-4 rounded-md mr-6 bg-red-500' onClick={props.openConfirmation}>Delete</button>}
                        {props.addingChallengeBool && props.edit && props.maxPpl === props.currentPpl && <button type="button" className='jura lg:text-4xl md:text-3xl sm:text-2xl text-xl py-2 px-4 rounded-md mr-6 bgOrange' onClick={props.openScoresModal}>Input Scores</button>}
                        ...
                        <button type="button" className={'jura lg:text-4xl md:text-3xl sm:text-2xl text-xl  py-2 px-4 rounded-md bgOrange'} onClick={props.edit ? props.closeEditMatchModal : props.handleCloseModal}>{props.edit ? "Cancel" : "Close"}</button>
                    </div>
                </form>
            </div>
        </div>
