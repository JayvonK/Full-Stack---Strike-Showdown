  ...
  return (
    <div className='md:px-10 sm:px-8 px-4'>
      ...
      <div className='flex my-5'>
        <div className='2xl:mr-8 md:mr-16 sm:mr-8 mr-4'>
          <div className='md:w-[105px] md:h-[105px] sm:w-[100px] sm:h-[100px] w-[75px] h-[75px]'>
            <img className='w-full h-full rounded-full object-cover' src={props.data.profileImage} alt="bowler's pfp" />
          </div>
        </div>
        ...
        <div className='lg:grid 2xl:grid-cols-[22%_34%_24%_20%] grid-cols-[25%_40%_35%] w-full hidden'>
          <div className='pr-8 xl:text-xl sm:text-lg text-sm'>
            ...
            <h3 className='juraBold txtOrange underline cursor-pointer' onClick={props.userClick}>{props.data.username}</h3>
          </div>
